...
from ORIGINAL.cbs_mapf.planner import Planner
...
def load_scenario(fd):
    with open(fd, 'r') as f:
        ...
        START = data['START']
        GOAL = data['GOAL']
        return data['GRID_SIZE'], data['ROBOT_RADIUS'], data['RECT_OBSTACLES'], data['START'], data['GOAL']
...
if __name__ == '__main__':
    ...
    # python3 interface.py scenario1.yaml
